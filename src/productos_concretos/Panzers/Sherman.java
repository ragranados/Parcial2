...
public class Sherman implements Tanque ,Unidad{
    ...
    public String getNombreUnidad(){
        return "Tanque Sherman";
    }

    @Override
    public void destruir() {
        throw new UnsupportedOperationException("Tanque Sherman Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    @Override
    public Edificaciones getTipoEdificacion() {
        throw new UnsupportedOperationException(" edif Tanque Sherman edificacion Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }
